...
public class Application extends BasicBean{
	...
	public String toString() {
		return "Application [NAME=" + NAME + ", CREATED_BY=" + CREATED_BY + ", CREATION_TIME=" + CREATION_TIME
				+ ", LAST_MODIFICATION_TIME=" + LAST_MODIFICATION_TIME + ", LAST_MODIFICATION_BY="
				+ LAST_MODIFICATION_BY + ", DESCRIPTION=" + DESCRIPTION + ", NO_OF_EVALUATORS=" + NO_OF_EVALUATORS
				+ ", FIRST_EVALUATOR=" + FIRST_EVALUATOR + ", id=" + id + ", INVESTOR_ID=" + INVESTOR_ID
				+ ", SECOND_EVALUATOR=" + SECOND_EVALUATOR + ", THIRD_EVALUATOR=" + THIRD_EVALUATOR + ", TOTAL_POINTS="
				+ TOTAL_POINTS + "]";
	}
